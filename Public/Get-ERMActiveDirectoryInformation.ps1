function Get-ERMActiveDirectoryInformation {
    ...
    try {
        ...
        try{
            ...
            $Warnings +=
                "Unable to determine domain controller role."
        }
        ...
        if(-not $DomainJoined){
            $Warnings +=
                "Computer is not domain joined. Active Directory discovery skipped."
        ...
        try{
            ...
            $Errors +=
                "Unable to retrieve forest information: $($_.Exception.Message)"
        }
        ...
        try{
            ...
            $Errors +=
                "Unable to retrieve domain information: $($_.Exception.Message)"
        }
        ...
        try{
            ...
            $Errors +=
                "Unable to enumerate domain controllers: $($_.Exception.Message)"
        }
